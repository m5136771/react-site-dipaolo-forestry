...
import { ReactComponent as SvgDecoratorBlob1 } from "assets/svg-decorator-blob-4.svg";
import { ReactComponent as SvgDecoratorBlob2 } from "assets/svg-decorator-blob-5.svg";
import GiffordPinchot from 'assets/Gifford_Pinchot.jpg';
...
const DecoratorBlob2 = tw(
  SvgDecoratorBlob2
)`absolute w-32 bottom-0 right-0 -z-10 text-accent opacity-15 transform translate-x-2/3 translate-y-8`;

export default () => {
  const testimonials = [
    {
      imageSrc: GiffordPinchot,
      quote:
        "The purpose of conservation: The greatest good to the greatest number of people for the longest time.",
      customerName: "Gifford Pinchot",
      customerTitle: "The Father of Forestry (U.S. National Park Service)"
    }
  ];
  return (
    <Container>
      <Content>
        <HeadingInfoContainer>
          <HeadingTitle>Conservation</HeadingTitle>
